...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.TripViewHolder> {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter.TripViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.TripViewHolder holder, int position) {
    ...
    /*    TextView pt_pickup;
        ...
        public TripViewHolder(@NonNull View itemView) {
         ...
         /*   pt_pickup = itemView.findViewById(R.id.pt_pickup);
            ...
            pt_driver_name = itemView.findViewById(R.id.pt_driver_name);
